...
<div id="programlist" class="programlistbox pclistnav">
    <!--<h1 class="pcheadertitle">众筹项目列表</h1>-->
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="positiononly clearfix">
            ...
            <?php if(($vo["status"]) == "1"): ?><h2 class="pctips state2"><span>众筹中</span></h2><?php endif; ?>
            <?php if(($vo["status"]) == "2"): ?><h2 class="pctips state3"><span>众筹成功</span></h2><?php endif; ?>
            <?php if(($vo["status"]) == "3"): ?><h2 class="pctips state3"><span>众筹成功</span></h2><?php endif; ?>
            <div class="pcprpic">
                <a href="<?php echo U('Zhongchou/details',array('id'=>$vo['id']));?>">
                    <img src="<?php echo ((isset($vo["url1"]) && ($vo["url1"] !== ""))?($vo["url1"]):''); ?>" alt="<?php echo ((isset($vo["title"]) && ($vo["title"] !== ""))?($vo["title"]):'众筹项目'); ?>">
                </a>
            </div>
            <div class="rightbox">
                <h3 class="programtitle"><a href="<?php echo U('Zhongchou/details',array('id'=>$vo['id']));?>">[众筹]<?php echo ((isset($vo["title"]) && ($vo["title"] !== ""))?($vo["title"]):'众筹项目'); ?></a></h3>
                ...
                <ul class="pcfendet">
                    <li><span>众筹价格：</span><?php echo ((isset($vo["price"]) && ($vo["price"] !== ""))?($vo["price"]):'0.00'); echo (getCurrencynameByCurrency($vo["buy_currency_id"])); ?></li>
                    <li><span>最低数量：</span><?php echo ((isset($vo["min_limit"]) && ($vo["min_limit"] !== ""))?($vo["min_limit"]):'0.00'); ?>个</li>
                    <li><span>众筹目标：</span><?php echo (floatval($vo['num'])); ?>个</li>
                </ul>
                <div class="pclastdate">
                    ...
                    <?php if(($vo["status"]) == "1"): ?><span class="timeste_4"><a href="<?php echo U('Zhongchou/details',array('id'=>$vo['id']));?>"><input style=" cursor: pointer;" type="button" class="btn-play-1" value="项目众筹中,火速加入"></a></span></span><?php endif; ?>
