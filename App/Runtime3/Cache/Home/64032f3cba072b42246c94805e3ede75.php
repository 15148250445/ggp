	...
	<div class="main_box">
        ...
        <div class="coin_style_box">
			...
			<ul class="item">
				...
				<li class="c_3">
					总资产：<span data-flaunt="0.00" class="cny_cny_loan">￥<?php echo ($u_info['rmb']+$u_info['forzen_rmb']); ?></span>
				</li>
				<li class="c_4">
	   ...
	   <!-- 账户总资产估算新改:-->
			...
			<thead>
				<tr class="list_head">
					...
					<th class="assets02.5">操作&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<th class="assets02.5">去交易&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
				</tr>
			</thead>
			<tbody>
				<tr class="list_con1">
				    ...
				    <td class="cost assets02.5">
					<a  href="javascript:void(0)" onclick="confirm_fill();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;充值</a>
					&nbsp;&nbsp;<a href="<?php echo U('User/draw');?>">提现</a></td>
				  	<td></td>
				</tr>
				<?php if(is_array($currency_user)): $i = 0; $__LIST__ = $currency_user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="list_con2">
						...
						<a href="<?php echo U('Pay/bpay',['currency_id'=>$vo['currency_id']]);?>">充币</a>
                        &nbsp;&nbsp;<a href="/Home/Pay/tcoin/currency_id/28.html">提币</a>
						</td>
